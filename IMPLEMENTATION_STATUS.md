...
- 更新日: 2026年8月9日
- MVP進捗: **0/7**
- 現在地: M1 静的基盤と自動試験を実装中（Draft PR準備）
- 実装コード: M1のDraft PR準備中

## MVP工程

| 工程 | 内容 | 状態 | Pull Request |
|---|---|---|---|
| M1 | 静的基盤と自動試験 | 実装中（Draft PR準備） | — |
...
M1のDraft Pull RequestでCIとブラウザ試験の結果を確認し、ユーザー本人の承認後にReady化とマージを行う。マージ後にM1を1/7へ更新し、M2へ進む。
